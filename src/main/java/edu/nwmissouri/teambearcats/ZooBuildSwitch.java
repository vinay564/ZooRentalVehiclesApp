...
public class ZooBuildSwitch {
    ...
    private static final String relativePathToPackage = "/src/main/java/edu/nwmissouri/teambearcats";
    ...
    public static Map<Integer, String> getAllAnimalMap() {
        ...
        for (String file : filesArray) {
            if (!ignoreList.contains(file)) {
                ...
                if (justName.endsWith("Vehicle")) {
                    var animal = justName.replace("Vehicle", "");
        ...
        for (String file : filesArray) {
            if (!ignoreList.contains(file)) {
                ...
                if (justName.endsWith("Vehicle")) {
                    ...
                    System.out.println(justName + ".move();");
                    System.out.println(justName + ".speed();");
                    System.out.println("}");
                }
            }
        }
